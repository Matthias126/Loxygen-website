...
export function buildAfricaRoadtripJsonLd() {
  return {
    ...
    name: "Africa Roadtrip 2026",
    description:
      "A 6-day boots-on-the-ground logistics journey across Egypt, Tunisia and Morocco for logistics professionals, capped at 10 participants.",
    provider: {
      "@type": "Organization",
      name: SITE_NAME,
      sameAs: SITE_URL,
    ...
    offers: {
      ...
      price: "3555",
      priceCurrency: "EUR",
      url: `${SITE_URL}/africa-roadtrip-2026`,
    },
  };
}
