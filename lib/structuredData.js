...
const COURSE_TOPICS = [
  ...
  },
  {
    ...
    url: `${SITE_URL}/breakbulk-training`,
  },
  {
    ...
    url: `${SITE_URL}/courses/international-trade-and-transport`,
  },
  {
...
export function buildCourseDetailJsonLd(course, url) {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Course",
    name: course.title,
    description: stripMarkdown(course.description) || undefined,
    provider: {
      "@type": "Organization",
      name: SITE_NAME,
      sameAs: SITE_URL,
  ...
  const offers = (
    course.tiers?.length > 0
      ...
      : course.price
        ? [{ "@type": "Offer", price: String(course.price), priceCurrency: "EUR", url }]
        : []
  );
...
const PROGRAMMES = [
  ...
  },
  {
    ...
    description:
      "Bite-sized lessons delivered year-round, for teams learning in the flow of work.",
  },
  {
  ...
  {
    name: "North Africa Learning Trip 2026",
    description:
...
export function buildUpcomingCoursesJsonLd(upcomingCourses) {
  return courseInstanceItemListJsonLd(
    upcomingCourses.map((course) => ({
      name: course.title,
      description: stripMarkdown(course.description),
...
const BREAKBULK_TIERS = [
  {
    ...
    description:
      "Bite-sized breakbulk knowledge delivered through short webinars.",
    courseMode: "online",
    inLanguage: "en",
    startDate: "2026-06",
  },
...
export function buildYoungForwardersJsonLd() {
  return {
    ...
    description:
      "A 6-day immersion week through European ports and logistics hubs for freight forwarders aged 22–35, open to SeaBlue Project Logistics Network, CrossTrades and Flyte members.",
    provider: {
      "@type": "Organization",
      name: SITE_NAME,
      sameAs: SITE_URL,
...
export function buildNorthAfricaLearningTripJsonLd() {
  return {
    "@context": "https://schema.org",
    "@type": "Course",
    name: "North Africa Learning Trip 2026",
    ...
    hasCourseInstance: {
      ...
      location: {
        "@type": "Place",
        name: "Egypt, Tunisia and Morocco",
      },
...
export function buildSustainabilityAwardJsonLd() {
  return {
    ...
    // Search Console flags eventStatus/endDate/location.address as missing —
    // Event's default status when nothing has changed, and an image we
    // already have and use as this page's own og:image.
    eventStatus: "https://schema.org/EventScheduled",
    eventAttendanceMode: "https://schema.org/OfflineEventAttendanceMode",
    startDate: "2026-09",
    image: `${SITE_URL}/images/sustainability-award.jpg`,
    location: {
      "@type": "Place",
      name: "Vietnam AGM",
    },
...
export function buildMicroLearningsJsonLd() {
  return {
    ...
    name: "Micro-learnings",
    description:
      "Bite-sized logistics and freight forwarding lessons delivered year-round, for teams learning in the flow of work.",
    provider: {
      "@type": "Organization",
      name: SITE_NAME,
      sameAs: SITE_URL,
...
export const HELP_FAQ = [
  ...
  {
    question: "After subscribing to micro-learnings, how do I get access?",
    answer:
      "After your subscription payment is confirmed, we set up your account and send the login details to the email address you used at checkout. This is a manual step on our side, so allow up to one business day.",
  },
  {
  ...
  return [
    {
      ...
      name: SITE_NAME,
      url: SITE_URL,
      // No dedicated logo asset exists yet (navbar uses styled text, not an
      // image) — favicon.png is a real file at least, though at 64x64 it's
      // below Google's recommended 112x112 minimum for this field.
