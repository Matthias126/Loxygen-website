...
export function buildPasswordResetEmail({ resetUrl }) {
  return {
    ...
    html: `
      <p>Someone requested a password reset for this Loxygen Academy account.</p>
      <p><a href="${escapeHtml(resetUrl)}">Click here to set a new password</a>. This link expires in 1 hour.</p>
