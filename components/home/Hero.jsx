  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-6xl px-6 pt-24 pb-10 text-center lg:px-8 lg:pt-32">
        <h1 className="font-display mx-auto text-hero tracking-tight text-brand-navy">
          <span className="block">Logistics training,</span>
          <span className="block italic text-brand-accent">built to move global freight</span>
        </h1>
        ...
        <div className="mt-9 flex items-center justify-center gap-3">
          ...
          <Link
            ...
            className="group inline-flex h-[52px] w-[52px] items-center justify-center rounded-full bg-brand-navy text-lg text-white hover:bg-brand-navy/90"
          >
      ...
      <div className="mx-auto max-w-6xl px-6 pb-20 lg:px-8">
        <div className="relative aspect-[21/9] overflow-hidden rounded-3xl bg-white">
          <Image
            ...
            alt="The Loxygen Academy group standing beneath a container crane at a chemical/tank terminal"
            fill
